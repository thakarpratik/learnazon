...
export const metadata: Metadata = {
  title: "Child Safety — KidLearn",
  description: "How KidLearn keeps children safe online. Our COPPA compliance, data practices, and parent controls explained.",
...
const SAFEGUARDS = [
  ...
  { emoji: "👤", title: "No Personal Data from Children", desc: "Children only need a name and PIN to use KidLearn. No email, phone number, photo, or location is ever collected from them." },
  ...
  { emoji: "📵", title: "No External Links", desc: "The child-facing app contains no links to external websites. Children cannot accidentally navigate away from KidLearn." },
];
      ...
      <main id="main-content" className="pt-24 pb-20">
        ...
        <section className="py-16 text-center bg-blue-50 border-b border-blue-100">
          <div className="section-container max-w-3xl">
            ...
            <p className="text-xl text-gray-500 max-w-2xl mx-auto leading-relaxed">
              KidLearn was built by a parent. Child safety isn&apos;t a compliance checkbox for us — it&apos;s the foundation everything else is built on.
            </p>
          </div>
        </section>
        ...
        <section className="py-20" style={{ background: "linear-gradient(135deg, #FFF3E8 0%, #F0FDF9 100%)" }}>
          <div className="section-container max-w-3xl">
            ...
            <p className="text-center text-gray-500 mb-10">Everything your child does on KidLearn is visible to you.</p>
        ...
        <section className="py-16 bg-white border-t border-gray-100">
          <div className="section-container max-w-2xl text-center">
            ...
            <p className="text-gray-500 mb-6">
              If you encounter anything on KidLearn that feels inappropriate or unsafe, please report it immediately. We take all reports seriously and respond within 24 hours.
            </p>
            <a href="mailto:safety@kidlearn.app"
