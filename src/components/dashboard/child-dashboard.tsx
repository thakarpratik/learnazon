...
import { LearningStyleModal, useGameMode } from "@/components/dashboard/learning-style-modal";
...
const MODULES = [
  ...
  {
    id: "money",    label: "Money",       adventureLabel: "Mario Money",     adventureEmoji: "🪙",
    href: "/learn/money",   adventureHref: "/learn/missions/money",   premium: true,
  ...
  {
    id: "speaking", label: "Speaking",    adventureLabel: "Talent Show",     adventureEmoji: "🎤",
    href: "/learn/speaking", adventureHref: "/learn/missions/speaking", premium: true,
  ...
  {
    id: "life",     label: "Life Skills", adventureLabel: "Hero Skills",     adventureEmoji: "🦸",
    href: "/learn/life",    adventureHref: "/learn/missions/life",    premium: true,
  ...
  },
  {
    ...
    href: "/learn/writing", adventureHref: "/learn/missions/writing", premium: true,
  ...
  },
  {
    ...
    href: "/learn/science", adventureHref: "/learn/missions/science", premium: true,
  ...
  },
  {
    ...
    href: "/learn/spanish", adventureHref: "/learn/missions/spanish", premium: true,
  ...
  },
  {
    ...
    href: "/learn/movies",  adventureHref: "/learn/missions/movies",  premium: true,
...
export function ChildDashboard() {
  ...
  return (
    <div className="min-h-screen relative">
      ...
      {/* ── Learning style modal (first visit) ── */}
      {gameMode === null && (
        <LearningStyleModal
          displayName={displayName}
          favoriteColor={theme.color}
          onChoose={setGameMode}
        />
      )}
      ...
      <header className="px-4 pt-6 pb-4 max-w-2xl mx-auto">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 flex-wrap justify-end">
            ...
            {gameMode !== null && (
              <button
                onClick={() => setGameMode(gameMode === "adventure" ? "quiz" : "adventure")}
                className="flex items-center gap-1 rounded-2xl px-3 py-2 font-bold text-xs transition-all duration-150 hover:-translate-y-0.5"
                style={{
                  background: gameMode === "adventure"
                    ? (isDark ? "rgba(21,101,192,0.3)" : "#E3F2FD")
                    : (isDark ? "rgba(249,115,22,0.3)" : "#FFF7ED"),
                  color: gameMode === "adventure"
                    ? (isDark ? "#90CAF9" : "#1565C0")
                    : (isDark ? "#FED7AA" : "#C2410C"),
                  border: `2px solid ${gameMode === "adventure" ? (isDark ? "rgba(144,202,249,0.4)" : "#90CAF9") : (isDark ? "rgba(254,215,170,0.4)" : "#FCD34D")}`,
                }}
                title={`Switch to ${gameMode === "adventure" ? "Quiz" : "Adventure"} Mode`}
              >
                {gameMode === "adventure" ? "🎮" : "📝"}
                <span className="hidden sm:inline">{gameMode === "adventure" ? "Adventure" : "Quiz"}</span>
              </button>
            )}
